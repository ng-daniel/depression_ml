...
def print_model_performance_table(model_performance_dicts: list):
    ...
    NAME_COL_WIDTH = max_name_length + 4

    print('-'*COL_WIDTH*(NUM_COLS-1) + '-'*NAME_COL_WIDTH)
    print(f"{'name':{NAME_COL_WIDTH}}{'#samples':>{COL_WIDTH}}{'loss':>{COL_WIDTH}}{'accuracy':>{COL_WIDTH}}{'precision':>{COL_WIDTH}}{'recall':>{COL_WIDTH}}{'f1':>{COL_WIDTH}}\n")
    for d in model_performance_dicts:
