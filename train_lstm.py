...
print("--------------------------------")
print("PROCESS: LSTM V1 TRAINING")
...
from core.training_loops import run_lstm
...
# augment data for LSTM v1 and wrap into dataloaders
dataloaders = []
...
for i in tqdm(range(30), ncols=50):
    ...
    lstm_results_list.append(lstm_results)
    print(lstm_results)
metrics = combine_several_weighted_averages(lstm_results_list)
metrics.to_csv(os.path.join(RESULTS_DIR, "lstm_30_metrics.csv"))
print(metrics)
